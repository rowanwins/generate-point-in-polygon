...
import generatePointInPoly from '../src/main.js'
...
test('fixtures', (t) => {
    fixtures.forEach((filepath) => {
        ...
        const p = generatePointInPoly(geojson.geometry.coordinates[0])
...
test('test pre-seeded concave vertice', (t) => {
    ...
    const p = generatePointInPoly(switzerland.geometry.coordinates[0], 745)
